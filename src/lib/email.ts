...
export async function sendJobSubmissionNotification(data: JobSubmissionEmailData): Promise<void> {
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p style="margin: 5px 0 0 0; opacity: 0.9;">Student Jobs Delft</p>
        </div>
        ...
        <div class="footer">
          <p>This is an automated notification from Student Jobs Delft</p>
          <p>Submission received at ${new Date().toLocaleString('nl-NL', { timeZone: 'Europe/Delft' })}</p>
        </div>
      </div>
    </body>
    </html>
  ...
  const textContent = `
New Job Submission - Student Jobs Delft
==========================================
...
Received at ${new Date().toLocaleString('nl-NL', { timeZone: 'Europe/Delft' })}
  `.trim();

  const mailOptions = {
    from: `"${process.env.GMAIL_FROM_NAME || 'Student Jobs Delft'}" <${process.env.GMAIL_FROM_ADDRESS || process.env.GMAIL_USERNAME}>`,
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p style="margin: 10px 0 0 0; opacity: 0.9;">Student Jobs Delft</p>
        </div>
        ...
        <div class="content">
          ...
          <ol>
            ...
            <li>Once approved, your job will be published on Student Jobs Delft</li>
          ...
          <p>Best regards,<br>
          <strong>Student Jobs Delft Team</strong></p>
        </div>
        
        <div class="footer">
          <p>Student Jobs Delft | Connecting students with opportunities</p>
          <p><a href="https://studentjobsdelft.nl">studentjobsdelft.nl</a></p>
        </div>
      </div>
    </body>
    </html>
