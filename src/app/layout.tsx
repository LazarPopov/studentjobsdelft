...
const SITE_URL = "https://studentjobsdelft.nl";
const SITE_NAME = "Student Jobs Delft";
...
export const metadata: Metadata = {
  ...
  description:
    "Find student jobs in Delft: English friendly roles, fast apply tips, and real pay ranges.",
