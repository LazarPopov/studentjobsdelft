...
export function generateMetadata({ params }: { params: { slug: string } }): Metadata {
  ...
  const city = (job.addressLocality ? String(job.addressLocality) : "Delft").trim();
...
export default function JobPage({ params }: { params: { slug: string } }) {
  ...
  const cityPrefill =
    (job.addressLocality ? String(job.addressLocality) : "delft").toLowerCase();
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-4 card overflow-hidden">
          ...
          <JobApplyForm
            ...
            jobTitle={job.title}
            orgName={job.orgName}
            city={(job.addressLocality || "delft").toLowerCase()}
