...
export const metadata: Metadata = {
  title: "Partners | Student Jobs Delft",
  description:
    "Our SEO, community, and hiring partners helping students find great jobs in Delft.",
  alternates: { canonical: "https://studentjobsdelft.nl/partners" },
  openGraph: {
    title: "Partners | Student Jobs Delft",
    description:
      "Our SEO, community, and hiring partners helping students find great jobs in Delft.",
    url: "https://studentjobsdelft.nl/partners",
    type: "website",
  },
};
...
const PARTNERS: Partner[] = [
  ...
  //   url: "https://thestoragescanner.com/en-NL/cities/zuid-holland/Delft",
  //   descriptionHtml:
  //     `The leading independent platform in Delft for comparing self-storage providers. Easily find and compare storage units and garage boxes by location, size, and price. Explore <a href="https://thestoragescanner.com/en-NL/cities/zuid-holland/Delft" target="_blank" rel="noopener noreferrer">self storage in Delft</a> to choose the best option for your budget.`,
  ...
  },
  {
    ...
    descriptionHtml:
      `A handover marketplace that connects leaving tenants with incoming renters to reduce vacancy time and friction. Great for discovering <a href="https://rentswap.io" target="_blank" rel="noopener noreferrer">student rooms in Delft</a> through warm introductions.`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ItemList",
            name: "Student Jobs Delft Partners",
